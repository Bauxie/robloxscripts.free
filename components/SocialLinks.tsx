...
const ICONS: Record<SocialPlatform, JSX.Element> = {
  ...
  gitlab: (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path d="m23.6 9.593-.033-.086L20.3.98a.851.851 0 0 0-.336-.405.876.876 0 0 0-1 .054.876.876 0 0 0-.29.44L16.47 7.818H7.537L5.334 1.07a.858.858 0 0 0-.29-.441.876.876 0 0 0-1-.054.859.859 0 0 0-.336.405L.433 9.502l-.032.086a6.066 6.066 0 0 0 2.012 7.01l.01.009.03.022 4.977 3.727 2.462 1.863 1.5 1.132a1.008 1.008 0 0 0 1.22 0l1.499-1.132 2.461-1.863 5.006-3.75.013-.01a6.068 6.068 0 0 0 2.01-7.003z" />
    </svg>
  ),
  roblox: (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      <path d="M5.164 0 .16 18.928 18.836 24l5.005-18.929L5.164 0Zm9.086 15.148-5.402-1.46 1.451-5.406 5.403 1.46-1.452 5.406Z" />
    </svg>
  ),
  spotify: (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden>
